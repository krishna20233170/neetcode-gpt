...
# 1. Include an additional LayerNorm after the block sequence and before the final linear layer
# 2. Instantiate in order: Word embeddings, position embeddings, transformer blocks,
#    final layer norm, and vocabulary projection.
class GPT(nn.Module):
    ...
    def forward(self, context: TensorType[int]) -> TensorType[float]:
        torch.manual_seed(0)
        # 1. Add token embeddings + position embeddings
